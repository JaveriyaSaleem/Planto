...
const Card2 = () => {
  return (
    <div className='bg-white/5 backdrop-blur-md px-6 pb-5  rounded-3xl  sm:rounded-[100px] shadow-lg border border-white/10 lg:w-6xl mx-auto my-10'>
      <figure className='flex flex-col-reverse sm:grid sm:grid-cols-2'>

        
        <figcaption className='text-white flex flex-col sm:justify-center text-left gap-2 sm:ps-20'>
            ...
            <div className='-mt-10 sm:ps-30'><img src={img} alt="" className='w-60 px-7'/></div>
